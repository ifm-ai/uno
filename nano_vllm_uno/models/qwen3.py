...
from nano_vllm_uno.layers.linear import QKVParallelLinear, MergedColumnParallelLinear, RowParallelLinear
...
from nano_vllm_uno.layers.embed_head import VocabParallelEmbedding, ParallelLMHead
...
class Qwen3Model(nn.Module):
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [
                Qwen3DecoderLayer(config, quant_method, attention_backend)
...
class Qwen3ForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.model = Qwen3Model(config, attention_backend)
