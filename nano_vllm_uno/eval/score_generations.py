...
from .code_grader import score_code
from .math_grader import score_math
from .multiple_choice import score_multiple_choice
from .parsers import (
    apply_parser,
    load_source_records,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "nano_vllm_uno.eval.generate_benchmark."
        ),
    )
    parser.add_argument(
        "--data",
...
def main() -> None:
    ...
    if task in MATH_TASKS:
        graded, summary = score_math(rows)
        ...
        from .lcb_grader import score_lcbv6
        ...
        from .ifeval_grader import score_ifeval
